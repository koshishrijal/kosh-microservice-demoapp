package com.kosh.blogservice.database;
...
@EnableJpaRepositories(
        basePackages = {"com.kosh.blogservice.blog"},
...
public class BlogAppDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean blogAppEntityManager(
        ...
        return builder.dataSource(blogAppDataSource()).properties(jpaProperties).packages("com.kosh.blogservice.blog")
                .build();
    }
